<template>
  <div
    class="h-[442px] w-full max-w-[912px] mx-auto relative overflow-visible bg-(--system-background)"
  >
      ...
      >
        <div class="min-w-full h-full flex items-center justify-center px-6 lg:px-[99px] py-[29px]">
          <div class="flex gap-[61px] items-center w-full max-w-[714px]">
            <div
              class="bg-(--system-ring) h-[385px] w-[265px] rounded-(--border-radius-xl) flex items-center justify-center relative"
            >
