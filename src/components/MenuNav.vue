<template>
    <nav :class="[ landing ? 'bg-(--system-foreground)' : '', 'h-20 flex justify-center' ]">
        <div class="flex w-full max-w-7xl items-center justify-between px-6 lg:px-[184px]">
            <img @click="landing ? $router.push({name:'landing'}) : $router.push({name:'home'})" src="./../assets/Logo.svg" class="h-10 cursor-pointer">
            <div class="flex gap-(--spacing-md) items-center">
                ...
                <template v-else>
                    ...
                    <div class="flex gap-4 text-(--text-body-titles)">
                        <span @click="toggleDarkMode" class="material-symbols-outlined cursor-pointer hover:opacity-70 transition-opacity">
                            {{isDark ? 'dark_mode' : 'light_mode'}}
                        </span>
                        <span class="material-symbols-outlined cursor-pointer hover:opacity-70 transition-opacity">grid_on</span>
                        <div class="relative">
                            <span 
